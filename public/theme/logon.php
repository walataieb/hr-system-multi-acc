    ...
    <span class="btn btn-primary btn-xs" data-dismiss="modal"><i class="fa fa-times"></i> Chiudi</span>
						...
						<div class="ace-settings-container" id="ace-settings-container">
                          ...
                          <div class="ace-settings-box clearfix" id="ace-settings-box">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h4 class='header blue'><i class='fa fa-tachometer'></i> Hr-Web</h4>
<div class='space-6'></div><div class='space-6'></div><div class='col-md-8 col-md-offset-2'><img class='img img-rounded' style='width:100%; height:100%; box-shadow:5px 5px 5px 5px #000;' src='img/logo2.jpg'/></div>
